...
for data in curs.fetchall():
	print ",['"+str(data[1])+"',"+str(data[4])+"]"
print		 "]);"
db.close()

print "		   var options = {"
print "		     title: 'Variable Lluvia'	 };"
...
print "</head>"
print "<body>"
print "<h1><center>Grafica de Lluvia</center></h1>"
print "<center>"
...
print '<meta http-equiv="refresh" content="28;URL=http://192.168.2.100/lluvia.py">'
#print '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">'
