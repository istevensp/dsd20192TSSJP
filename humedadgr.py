...
print "		 ['Fecha', 'Humedad de la tierra']"
...
print "		   var options = {"
print "		     title: 'Variables Humedad de la Tierra'	 };"
...
print "</head>"
print "<body>"
print "<h1><center>Grafica de la humedad de la tierra</center></h1>"
print "<center>"
...
print '<meta http-equiv="refresh" content="28;URL=http://192.168.2.100/humedadgr.py">'
#print '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">'
