...
print "		 ['Fecha', 'Temperatura']"
for data in curs.fetchall():
	print ",['"+str(data[1])+"',"+str(data[6])+"]"
print		 "]);"
db.close()

print "		   var options = {"
print "		     title: 'Variable Temperatura'	 };"
...
print "</head>"
print "<body>"
print "<h1><center>Grafica de Temperatura</center></h1>"
print "<center>"
...
print '<meta http-equiv="refresh" content="28;URL=http://192.168.2.100/temperatura.py">'
#print '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">'
